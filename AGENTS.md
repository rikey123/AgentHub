...
This project is indexed by GitNexus as **AgentHub** (7354 symbols, 14205 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
