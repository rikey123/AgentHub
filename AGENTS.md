...
This project is indexed by GitNexus as **AgentHub** (9355 symbols, 18158 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
