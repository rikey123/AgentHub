...
function seedWorkspace(): void {
  ...
  currentDatabase().sqlite.prepare("INSERT INTO runtimes (id, workspace_id, kind, name, manifest_json, created_at, updated_at) VALUES ('runtime_mock', 'ws_1', 'mock', 'Mock', '{}', 1, 1)").run();
  currentDatabase().sqlite.prepare("INSERT INTO roles (id, workspace_id, name, prompt, capabilities, is_builtin, created_at, updated_at) VALUES ('role_a', 'ws_1', 'Agent A', '', '[]', 0, 1, 1)").run();
  currentDatabase().sqlite.prepare("INSERT INTO roles (id, workspace_id, name, prompt, capabilities, is_builtin, created_at, updated_at) VALUES ('role_b', 'ws_1', 'Agent B', '', '[]', 0, 1, 1)").run();
  currentDatabase().sqlite.prepare("INSERT INTO roles (id, workspace_id, name, prompt, capabilities, is_builtin, created_at, updated_at) VALUES ('role_worker', 'ws_1', 'Worker', '', '[]', 0, 1, 1)").run();
  ...
  currentDatabase().sqlite.prepare("INSERT INTO agent_bindings (id, workspace_id, role_id, runtime_id, model_config_id, override_permission_profile_id, created_at, updated_at) VALUES ('agent_a', 'ws_1', 'role_a', 'runtime_mock', NULL, NULL, 1, 1)").run();
  currentDatabase().sqlite.prepare("INSERT INTO agent_bindings (id, workspace_id, role_id, runtime_id, model_config_id, override_permission_profile_id, created_at, updated_at) VALUES ('agent_b', 'ws_1', 'role_b', 'runtime_mock', NULL, NULL, 1, 1)").run();
  currentDatabase().sqlite.prepare("INSERT INTO agent_bindings (id, workspace_id, role_id, runtime_id, model_config_id, override_permission_profile_id, created_at, updated_at) VALUES ('agent_worker', 'ws_1', 'role_worker', 'runtime_mock', NULL, NULL, 1, 1)").run();
  ...
  currentDatabase().sqlite.prepare("INSERT INTO room_participants (room_id, participant_id, participant_type, role, adapter_id, adapter_session_id, agent_binding_id, default_presence, joined_at) VALUES ('room_a', 'agent_a', 'agent', 'primary', 'mock', NULL, 'agent_a', 'active', 1)").run();
  currentDatabase().sqlite.prepare("INSERT INTO room_participants (room_id, participant_id, participant_type, role, adapter_id, adapter_session_id, agent_binding_id, default_presence, joined_at) VALUES ('room_b', 'agent_b', 'agent', 'primary', 'mock', NULL, 'agent_b', 'active', 1)").run();
  currentDatabase().sqlite.prepare("INSERT INTO room_participants (room_id, participant_id, participant_type, role, adapter_id, adapter_session_id, agent_binding_id, default_presence, joined_at) VALUES ('room_team', 'agent_worker', 'agent', 'primary', 'mock', NULL, 'agent_worker', 'active', 1)").run();
  currentDatabase().sqlite.prepare("INSERT INTO room_participants (room_id, participant_id, participant_type, role, adapter_id, adapter_session_id, agent_binding_id, default_presence, joined_at) VALUES ('room_squad', 'agent_worker', 'agent', 'primary', 'mock', NULL, 'agent_worker', 'active', 1)").run();
}
