...
function seedRun(): void {
  ...
  currentDatabase().sqlite.prepare("INSERT INTO agent_bindings (id, workspace_id, role_id, runtime_id, model_config_id, override_permission_profile_id, created_at, updated_at) VALUES ('agent_1', 'ws_1', 'role_1', 'runtime_1', NULL, NULL, 1, 1)").run();
  ...
  currentDatabase().sqlite.prepare("INSERT INTO room_participants (room_id, participant_id, participant_type, role, adapter_id, adapter_session_id, agent_binding_id, default_presence, joined_at) VALUES ('room_1', 'agent_1', 'agent', 'primary', 'mock', NULL, 'agent_1', 'active', 1)").run();
