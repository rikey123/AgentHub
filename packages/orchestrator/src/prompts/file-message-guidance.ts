...
- Keep the public room message conversational: write a short public summary in one or two sentences, then mention the file only if you actually created one.
