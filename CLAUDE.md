...
This project is indexed by GitNexus as **AgentHub** (11755 symbols, 23737 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
